            ...
            <table id="table" class="table table-transparent">
                ...
                <tbody>
                    <?php foreach ($plants as $plant) { ?>
                        <tr>
                            <td><b><?= $plant->namelt ?><b></td>
                            <td><b><?= $plant->namelat ?></b></td>
                            <td><b><?= $plant->isperennial ? "augalas daugiametis" : "augalas vienmetis" ?></b></td>
                            <td><b><?= $plant->age . ' metai(-ų)' ?><b></td>
                            <td><b><?= $plant->height . ' m' ?></b></td>
                            <td>
                                <form action="" method="post">
                                    <input type="hidden" name="id" value="<?= $plant->id ?>">
                                    <button id="edit" class="btn btn-outline-warning" type="submit" name="edit"><b>Redaguoti</b></button>
                                </form>
                            </td>
                            <td>
                                <form action="" method="post">
                                    <input type="hidden" name="id" value="<?= $plant->id ?>">
                                    <button id="delete" class="btn btn-outline-danger" type="submit" name="destroy"><b>Ištrinti</b></button>
                                </form>
                            </td>
                        </tr>
                    <?php } ?>
