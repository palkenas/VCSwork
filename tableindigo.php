...
<head>
    ...
    <title>Plants indigo</title>
</head>

<body>
    <video id="background-video" autoplay loop muted poster="./images/Pexels Videos 2288346.mp4">
        <source src="./images/Pexels Videos 2288346.mp4" type="video/mp4">
    </video>
...
<a id="btnback" href="./indigo.php" class="btn btn-outline-dark" role="button">Sugrįžti</a>
<script>
